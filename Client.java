...
public class Client {
    ...
    protected void sendTextMessage(String text) {
        try {
            ...
            ConsoleHelper.writeMessage("Произошло исключение при отправке сообщения: " + e.getMessage());
    ...
    public void run() {
        ...
        synchronized (this) {
            try {
                ...
                ConsoleHelper.writeMessage("Во время ожидания возникло исключение: " + e.getMessage());
                return;
            }
        }
